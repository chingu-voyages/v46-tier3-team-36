...
const headingStyles = "text-blue-600 text-xl w-80 text-center"
...
const statusStyles = "w-40 text-center";
export { listItem, listItemSection, headingStyles, issueTitle, date, buttonBox, editBtn, deleteBtn, statusStyles }