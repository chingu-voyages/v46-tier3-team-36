...
const formOpened = "flex flex-col justify-around absolute md:w-1/3 h-3/4 m-10 p-2 border-2 rounded-xl shadow-sm shadow-black border-slate-300 bg-green-100"
...
export {formOpened, formClosed,formSection,inputStyles,btnInputStyles, textAreaStyles, selectStyles}